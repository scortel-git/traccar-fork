...
public class PriorNotificationReportProvider {
    ...
    @Inject
    public PriorNotificationReportProvider(Config config, ReportUtils reportUtils, Storage storage) {
        this.config = config;
        this.reportUtils = reportUtils;
        this.storage = storage;
    }

    public Collection<ElbPriorNotification> getObjects(long userId, Collection<Long> deviceIds, Collection<Long> groupIds,
    ...
    public void getExcel(OutputStream outputStream,
        ...
        for (Device device: DeviceUtil.getAccessibleDevices(storage, userId, deviceIds, groupIds)) {
            var priorNotifications = PriorNotificationUtil.getPriorNotifications(storage, device.getId(), from, to);
            ...
            deviceRoutes.setObjects(priorNotifications);
            devicesRoutes.add(deviceRoutes);
        }


        File file = Paths.get(config.getString(Keys.TEMPLATES_ROOT),
                "export",
                "prior-notification-report.xlsx").toFile();
