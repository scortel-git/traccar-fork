...
//ID -> {JsonNumberImpl$JsonLongNumber@8371} "15134759222"
        ...
        switch (mask) {
            ...
            case MSG_END_FISHING_TRIP:
                int error = 0;
                if (position.getLong("messageId") == 15146602876L) {
                    error =1;
                }
...
//                break;
                ...
                try {
                    while (fcRecLength > 0) {
                        ...
                        elbSpecies.setElbSpeciesExtended(buf.readShortLE()); // speciesSequenceNumber // code
